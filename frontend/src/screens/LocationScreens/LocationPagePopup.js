...
import Popup from '../../components/PortfolioSec_/Popup';
import $ from 'jquery';
...
const LocationPagePopup = ({locationPageDetails, editMode, reloadLocationPage, id}) => { 
    ...
    return ( 
        <Popup className='popup-blog-details' autoOpen={true} width="auto" onClose={PopupCloseHandler}>
            {loading ? <div className='w-100 text-center'> <Spinner style={{color: 'white', width: '120px', height: '120px'}} /> </div> : PopupModule()}
        </Popup> 
    )
}
